...
document.body.innerHTML = document.body.innerHTML.replace(
  "Disable Rank Display",
  "Ranganzeige deaktivieren"
);
...
document.body.innerHTML = document.body.innerHTML.replace(
  "Vulx Profile Editor - Made with ♡ by",
  "Vulx Profile Editor - Gemacht mit ♡ von "
);
document.body.innerHTML = document.body.innerHTML.replace(
  "Settings",
  "Einstellungen"
...
document.body.innerHTML = document.body.innerHTML.replace(
  ...
  '<font size="4px">Experimentelle Funktionen</font>'
);
document.body.innerHTML = document.body.innerHTML.replace(
  "DiscordRPC",
  '<font size="4px">Discord Status</font>'
);
document.body.innerHTML = document.body.innerHTML.replace(
  "Tool Tips",
  '<font size="4px">Tool-Tipps</font>'
);
document.body.innerHTML = document.body.innerHTML.replace(
  "Language",
  '<font size="4px">Sprache</font>'
);
document.body.innerHTML = document.body.innerHTML.replace(
  "Reset Account",
  '<font size="1px">Account zurücksetzen</font>'
);
